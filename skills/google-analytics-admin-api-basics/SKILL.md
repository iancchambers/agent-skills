...
license: Apache-2.0
metadata:
  source: https://github.com/google/skills (skills/analytics/google-analytics-admin-api-basics)
...
> House rule: anything IAM- or auth-related in this skill (credentials,
> developer tokens, service accounts, enabling APIs) is presented to Ian
> to run or approve — never executed directly. See AGENTS.md.
