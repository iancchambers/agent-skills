...
metadata:
  ...
  source: https://github.com/google/skills (skills/cloud/bigquery-basics)
description: >-
...
> House rule: anything IAM- or auth-related in this skill (roles, service
> accounts, enabling APIs) is presented to Ian to run or approve — never
> executed directly. See AGENTS.md.
