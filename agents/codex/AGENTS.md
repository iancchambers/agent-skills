...
Managed in the agent-skills repo; edit there, not in ~/.codex. Symlinked to
`~/.codex/AGENTS.md` by `install.sh`.
...
Shared skills are linked into `~/.codex/skills/`. Use them when their
