...
Managed in the agent-skills repo; edit there, not in ~/.claude. Symlinked to
`~/.claude/CLAUDE.md` by `install.sh`.
...
Shared skills are linked into `~/.claude/skills/`. Use them when their
