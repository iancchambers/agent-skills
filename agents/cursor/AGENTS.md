...
Managed in the agent-skills repo; edit there, not in ~/.cursor. Symlinked to
`~/.cursor/AGENTS.md` by `install.sh`.
...
Shared skills are linked into `~/.cursor/skills/`. Use them when their
